...
1.   Create a tree of the AOD data points.
2.   Query for the nearest neighbour mergerd AOD data points.
3.   Output will be the AOD data points nearer to the PM2.5 location.
4.   That will be the `nearest_neighbors` data frame.
...
nearest_neighbors.columns # Here nearest neighbours are the combined data points those are nearer to the PM2.5 data points LAt and Long.
